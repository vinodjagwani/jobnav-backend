...
public class OAuth2AccessTokenResponseConverter implements Converter<Map<String, String>, OAuth2AccessTokenResponse> {
    ...
    public OAuth2AccessTokenResponse convert(final Map<String, String> tokenResponseParameters) {
        final String accessToken = tokenResponseParameters.get(OAuth2ParameterNames.ACCESS_TOKEN);
        ...
        if (tokenResponseParameters.containsKey(OAuth2ParameterNames.EXPIRES_IN)) {
            try {
                ...
                log.warn("Invalid format for expiresIn ", ex);
            }
        }
    ...
    public final void setDefaultAccessTokenType(final OAuth2AccessToken.TokenType defaultAccessTokenType) {
